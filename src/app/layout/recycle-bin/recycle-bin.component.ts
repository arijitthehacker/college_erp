...
import { LeadDetailsComponent } from '../../shared/components/lead-details/lead-details.component';
...
export class RecycleBinComponent implements OnInit {
    ...
    models: any = [
        ...
        {name: 'Customer Leads', id: 'CustomerLeades'}
    ];
    ...
    openDetails(data) {
        if (data?.value_type === 'CustomerLeades' || this.model_name === 'CustomerLeades') {
            const modalRef = this.modalService.show(LeadDetailsComponent, {
